...
export default function App() {
  ...
  const header = {
    img: "https://i.ibb.co/twydS4g4/LOGO-1.png",
    brand: "BESTXTORE",
  ...
  const hero = {
    ...
    bg: "https://i.ibb.co/VYbX1Fs4/BACKGROUND.png",
  };
  ...
  const flashSale = {
    ...
    items: [
      {
        off: "-50%",
        title: "MX Master 3S PERformance Wireles Mouse",
        price: 29.99,
        oldPrice: 49.99,
        rating: 4.9,
        img: "",
      ...
      {
        off: "-30%",
        title: "Macbook Air 2020 13 inch Apple M1 Chip",
        price: 25.00,
        oldPrice: 35.00,
        rating: 4.8,
        img: "",
  ...
  const shared = { topbar, header, footer, mobileOpen, setMobileOpen };
